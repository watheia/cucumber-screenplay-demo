 ...
 * carla_the_online_customer@getnada.com | password | For the above data table
 ...
 * "value" "username" -> "carla_the_online_customer@getnada.com" "password" ->
 * "password"
 *
 * Example 2: Cucumber Data Table data: | username | password | |
 * carla_the_online_customer@getnada.com | password | |
 * adam_the_web_admin@mailinator.com | password | For the above data table the
 ...
 * "value" "username[0]" -> "carla_the_online_customer@getnada.com"
 * "password[0]" -> "password" "username[1]" ->
 * "adam_the_web_admin@mailinator.com" "password[1]" -> "password"
 *
