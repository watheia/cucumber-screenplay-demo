...
public class GlobalHeaderNavigationBar extends PageObject {
	...
	// public static By GET_LOGIN_SCREEN = By.jquery("#_desktop_user_info > div > a
	// > span");

	public static Target getLoginScreen() {
		if (RunEnvironment.ofValue() == RunEnvironment.Mobile) {
			GET_LOGIN_SCREEN = Target.the("Mobile Sign In Button").locatedBy("#_mobile_user_info > div > a");
		}
